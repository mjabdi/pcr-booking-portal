...
export default function DermaBookingCard({ booking }) {
  ...
  const getService = () =>
  {
    return (
      <React.Fragment>
        ...
        <span className={classes.itemData}> {`${booking.package}`} </span>
    </React.Fragment>
    )
  }
  ...
  {
    const href = `https://londonmedicalclinic.co.uk/medicalexpressclinic/user/edit/derma/${booking._id}`
    window.open(href, "_blank")
  }

  const openRegForm = () => {
    const href = `https://londonmedicalclinic.co.uk/medicalexpressclinic/user/form/derma/${booking._id}`
    window.open(href, "_blank")
  }
